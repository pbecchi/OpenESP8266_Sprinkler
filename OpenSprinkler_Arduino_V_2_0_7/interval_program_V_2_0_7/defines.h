...
// =================================================================
// Compiler switches - comment out or remove these defines to revert
// to standard OpenSprinkler hardware configuration
#define MOD_ARDUINO_LIBRARY    // use libraries from the Arduino IDE
#define MOD_DISCRETE           // use discrete IO instead of ShiftRegister
#define MOD_FREETRONICS_LCD    // use Freetronics LCD with keypad
#define MOD_W5100              // use Wiznet5100 Ethernet shield
// #define MOD_FREE_MEMORY        // display free memory on the LCD for debugging
#define MOD_DS1307             // use DS1307 realtime clock 
#define MOD_REMOTE_EXPANDER    // use a Remote Expander (watch this space)
#define MOD_AUTOREBOOT         // periodically auto reboot to ensure stable operation
#define USE_TINYFAT            // use a non standard CS pin for the SD card
// =================================================================

// Firmware version
#define SVC_FW_VERSION 206  // firmware version (207 means 2.0.7 etc)
...
#error "==This error is intentional==: you must define SVC_HW_VERSION in arduino-xxxx/libraries/OpenSprinklerGen2/defines.h"
  ...
  #define PIN_RF_DATA       28    // RF data pin 
  ...
  #ifdef MOD_FREETRONICS_LCD // <MOD> ===== Freetronics LCD Shield
    ...
    #define PIN_ETHER_CS       4    // Ethernet controller chip select pin - default is 4
    #define PIN_SD_CS          0    // SD card chip select pin - default is 0
  #endif
...
#define TMP_BUFFER_SIZE     255  // scratch buffer size - default = 48
  ...
  // Remember you have to reset the EEPROM before 
  // changes to any of the below will take effect
  
  #define PIN_ETHER_CS       10  // Ethernet controller chip select pin - default is 4
  #define PIN_SD_CS           4  // SD card chip select pin - default is 0
...
#define SPI_DEVICES   3                        // number of SPI devices
