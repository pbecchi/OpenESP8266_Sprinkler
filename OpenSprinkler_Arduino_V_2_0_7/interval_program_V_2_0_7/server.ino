...
{
#ifndef MOD_W5100 // <MOD> ===== Wiznet W5100 
...
byte streamfile (char* name) { //send a file to the buffer 
  ...
  while(myfile.available()) {
    ...
    int nbytes = myfile.read(EtherCard::buffer+54, 512);
#else
  ...
  ether.httpServerReply_with_flags(cur, TCP_FLAGS_ACK_V+TCP_FLAGS_FIN_V, 3);  //<MOD> Check this - should be 'OR'd?
